...
<div class="wpgs wpgs--with-images images"> 
	...
	<h1 class="product_title-entry-title">{{$t_foods->name}}</h1></div><div class="pro-price clearfix">
	         <span class="current-price"><span class="woocommerce-Price-amount amount">{{$t_foods->price}}<span class="woocommerce-Price-currencySymbol">&#8363;</span></span></span>
        <span class="original-price"><s><span class="woocommerce-Price-amount amount">{{ $t_foods->price_sale}}<span class="woocommerce-Price-currencySymbol">&#8363;</span></span></s></span>
